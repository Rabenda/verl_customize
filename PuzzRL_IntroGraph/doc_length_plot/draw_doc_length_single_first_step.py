...
- 细粒度直方图；加 --line 为折线图
- 默认输出矢量 PDF（与本目录 CSV 同放，可单独打包离线出图）
"""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="输出路径；默认 pic/plot_doc_length_single_first_step.pdf（矢量）。也可用 .png 等。",
    )
    ...
    out = args.save or os.path.join(dir_path, "pic", "plot_doc_length_single_first_step.pdf")
