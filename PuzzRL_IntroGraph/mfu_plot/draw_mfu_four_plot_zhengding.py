...
# (文件名, 模型名, 数据集名[, tool_times文件名或None]) — Search-R1；tool_times 与本脚本同目录（DOC_AND_TOOL_DIR）
FILES = [
...
# FAISS/tool 时间与 inference CSV 同目录（便于 PuzzRL_IntroGraph/mfu_plot 自包含）
DOC_AND_TOOL_DIR = os.path.dirname(os.path.abspath(__file__))
