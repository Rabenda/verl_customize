...
# MATH multiturn dataset (same as contri1_run_math_multiturn.sh)
MATH_DATA_DIR="/data/multi_turn_math"
...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files="$MATH_DATA_DIR/train.parquet" \
    data.val_files="$MATH_DATA_DIR/test.parquet" \
