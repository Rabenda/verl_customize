...
python3 -m verl.trainer.main_ppo_stone \
  ...
  \
  +actor_rollout_ref_a.rollout.mps_active_thread_percentage=100 \
  +actor_rollout_ref_b.rollout.mps_active_thread_percentage=100 \
  \
  ...
  trainer.fit_method=overlap_b_rollout_a_train \
